  ...
  describe('single router', () => {
    ...
    describe('Edge cases', () => {
      it('should handle multiple path parameters', async () => {
        ...
        const response = await singleRouterAppClient.users[':userId'].posts[':postId'].$get({
      ...
      it('should handle multiple query parameters', async () => {
        ...
        const response = await singleRouterAppClient.search.$get({
      ...
      it('should handle complex nested body', async () => {
        ...
        const response = await singleRouterAppClient['posts-with-author'].$post({
          json: {
            title: 'New Post',
      ...
      it('should handle query + path params + body', async () => {
        ...
        const response = await singleRouterAppClient.posts[':id'].update.$put({
          param: { id: '123' },
          query: { notify: 'true' },
      ...
      it('should handle empty optional body', async () => {
        ...
        const response = await singleRouterAppClient.posts[':id'].publish.$patch({
          param: { id: '123' },
        });
        const data = await response.json();
  ...
  describe('multiple routers', () => {
    ...
    describe('GET requests', () => {
      ...
      it('should handle GET request with query parameters', async () => {
        ...
        const response = await multipleRoutersAppClient.posts.$get({ query: { limit: '5' } });
        const data = await response.json();
      ...
      it('should handle GET request for posts with path parameters', async () => {
        ...
        const response = await multipleRoutersAppClient.posts[':id'].$get({ param: { id: '123' } });
        const data = await response.json();
    ...
    describe('POST requests', () => {
      it('should handle POST request with JSON body for users', async () => {
        ...
        const response = await multipleRoutersAppClient.users.$post({ json: { name: 'John Doe' } });
        const data = await response.json();
      ...
      it('should handle POST request with JSON body for posts', async () => {
        ...
        const response = await multipleRoutersAppClient.posts.$post({
          json: { title: 'New Post' },
        });
        const data = await response.json();
    ...
    describe('PUT requests', () => {
      it('should handle PUT request with JSON body for users', async () => {
        ...
        const response = await multipleRoutersAppClient.users[':userId'].$put({
          param: { userId: '123' },
      ...
      it('should handle PUT request with JSON body for posts', async () => {
        ...
        const response = await multipleRoutersAppClient.posts[':id'].$put({
          param: { id: '123' },
          json: { title: 'Updated Title' },
        });
        const data = await response.json();
    ...
    describe('PATCH requests', () => {
      it('should handle PATCH request with JSON body for users', async () => {
        ...
        const response = await multipleRoutersAppClient.users[':userId'].$patch({
          param: { userId: '123' },
      ...
      it('should handle PATCH request with JSON body for posts', async () => {
        ...
        const response = await multipleRoutersAppClient.posts[':id'].$patch({
          param: { id: '123' },
          json: { title: 'Patched Title' },
        });
        const data = await response.json();
    ...
    describe('DELETE requests', () => {
      it('should handle DELETE request for users', async () => {
        ...
        const response = await multipleRoutersAppClient.users[':userId'].$delete({
          param: { userId: '123' },
        });
        const data = await response.json();
      ...
      it('should handle DELETE request for posts', async () => {
        ...
        const response = await multipleRoutersAppClient.posts[':id'].$delete({
          param: { id: '123' },
        });
        const data = await response.json();
    ...
    describe('Edge cases', () => {
      it('should handle multiple query parameters', async () => {
        ...
        const response = await multipleRoutersAppClient.api.search.$get({
          query: { q: 'test', limit: '10', offset: '5' },
        });
        const data = await response.json();
      ...
      it('should handle complex nested body', async () => {
        ...
        const response = await multipleRoutersAppClient.api['posts-with-author'].$post({
          json: {
            title: 'New Post',
            author: { name: 'John Doe', email: 'john@example.com' },
            tags: ['tech', 'programming'],
      ...
      it('should handle nested routers with multiple path parameters', async () => {
        ...
        const response = await multipleRoutersAppClient.nested[':userId'].posts[':postId'].$get({
          param: { userId: 'u123', postId: 'p456' },
        });
        const data = await response.json();
